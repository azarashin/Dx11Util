========================================================================
    Win32 アプリケーション: DXSample プロジェクトの概要
========================================================================

この DXSample アプリケーションは、AppWizard により作成されました。
...
DXSample.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル DXSample.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル DXSample.rc 
    にインクルードされます。
