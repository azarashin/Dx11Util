...
Dx11EffectGUITrans::~Dx11EffectGUITrans(void)
{
}

HRESULT Dx11EffectGUITrans::Setup(Dx11Context* _context)
{
	HRESULT hr; 
...
UINT flagCompile = D3D10_SHADER_ENABLE_STRICTNESS | D3D10_SHADER_PACK_MATRIX_COLUMN_MAJOR;
	...
	hr = D3DCompileFromFileWrapper(
			L"shader\\gui_trans.hlsl",  // file name
	...
	// for view
	cBufferDesc.ByteWidth      = sizeof(Dx11EffectGUITransCBuffer);
...
HRESULT Dx11EffectGUITrans::Update(Dx11Context* _context, Dx11Object* obj, Dx11Motion* mot, Dx11Camera* cam, Dx11Lens* lens, float trans, float inv)
{
	...
	// データ書き込み
	CopyMemory(MappedResource.pData, &buf, sizeof(Dx11EffectGUITransCBuffer));
	// マップ解除
...
HRESULT Dx11EffectGUITrans::Term(Dx11Context* _context)
{
